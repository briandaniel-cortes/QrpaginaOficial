...
function dcms_list_data( $content ) {
	$database_name = 'id17139363_qr'; // nombre de la base de datos
	$database_user = 'id17139363_brian';
	$database_pass = '4|S?9sda46RneW#l';
	$database_server = 'localhost';

	$table_name = 'promociones'; // nombre de la tabla
	$slug_page = 'Promociones	'; //slug de la página en donde se mostrará la tabla

	if (is_page($slug_page)){

		$mydb = new wpdb($database_server,$database_user, $database_pass, $database_name );
